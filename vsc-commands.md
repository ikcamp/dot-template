...
extension.createRelatedFile
extension.rollbackCreates
...
io.orta.jest.show-output
io.orta.jest.start
io.orta.jest.stop
io.orta.jest.show-channel
io.orta.jest.coverage.metrics
io.orta.jest.coverage.toggle
git.refresh
git.openResource
git.clone
git.init
